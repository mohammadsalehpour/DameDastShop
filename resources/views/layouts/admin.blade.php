...
<head>
    ...
    <meta property="og:url" content="{{ URL::to('https://damedast.com/') }}" />
    <meta property="og:site_name" content="Keenthemes | Metronic" />
    <link rel="canonical" href="{{ URL::to('https://damedast.com/') }}" />
    <link rel="shortcut icon" href="{{ URL::asset('assets/media/logos/favicon.ico') }}" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="{{ URL::to('https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700') }}" />
    <!--end::Fonts-->
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    data-kt-app-toolbar-fixed-mobile="true" class="app-fluid">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="../../demo1/dist/index.html" class="d-lg-none">
                            <img alt="Logo" src="{{ URL::asset('assets/media/logos/default-small.svg') }}"
                                class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <!--begin::Logo image-->
                        <a href="../../demo1/dist/index.html">
                            <img alt="Logo" src="{{ URL::asset('assets/media/logos/default-dark.svg') }}"
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper"
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ Request::route()->getName() == 'admin.index' ? 'active' : '' }}"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ Request::route()->getName() == 'admin.users.index' ? 'active' : '' }}"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ Request::route()->getName() == 'admin.permissions.index' ? 'active' : '' }}"
    ...
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/index.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/xy.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/percent.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/radar.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/themes/Animated.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/map.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/geodata/worldLow.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/geodata/continentsLow.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/geodata/usaLow.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/geodata/worldTimeZonesLow.js') }}"></script>
    <script src="{{ URL::to('https://cdn.amcharts.com/lib/5/geodata/worldTimeZoneAreasLow.js') }}"></script>
