                    ...
                    <div class="col-md-4 fv-row mb-7 text-center">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url({{ URL::asset('assets/media/avatars/' . $user->profile_photo_path) }});">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="user_phone" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="+98 902 382 4525" value="{{ $user->phone }}" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            <label for="exampleFormControlTextarea1" class="form-label">Address</label>
                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" id="exampleFormControlTextarea1" rows="7">{{ $user->address }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-7">
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <input class="form-check-input me-3" name="user_role" type="radio"
                                            ...
                                            {{ $role->name == 'user' ? "checked='checked'" : '' }} />
                                        <!--end::Input-->
                                        <!--begin::Label-->
