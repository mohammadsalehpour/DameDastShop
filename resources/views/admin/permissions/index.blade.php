<x-admin-layout>
    ...
    <x-slot name="headerActions">
        <a href="{{ route('admin.permissions.create') }}" class="btn btn-sm fw-bold btn-primary">Create New Permission</a>
    </x-slot>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <h1 class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $permission->name }}
                                        </h1>
                                    </div>
                                </td>
                                <td class="">
                                    <span class="badge badge-light-warning">{{ $permission->guard_name }}</span>
                                </td>
                                <td class="text-muted fw-semibold">{{ $permission->created_at }}</td>
                                <td class="">
